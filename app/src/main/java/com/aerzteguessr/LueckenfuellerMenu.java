...
public class LueckenfuellerMenu extends Menu {
    ...
    public LueckenfuellerMenu(Settings settings) {
        ...
        buttons[3].addActionListener(e -> {
            new HowToPlayFrame(this, "app\\src\\main\\html\\howToPlayLueckenfueller.html");
        });
    ...
    private void openSettings() {
        ...
        cbUnlimitedTime.addActionListener(e -> {
        ...
        cbUnlimitedLives.addActionListener(e -> {
        ...
        bResetHighscore.addActionListener(e -> {
